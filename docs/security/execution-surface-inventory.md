...
- Surface records: `66`
- Category counts: `browser`=8, `cdp`=2, `cua`=3, `dev-only`=10, `download`=13, `gateway-ipc`=6, `gateway-route`=1, `installer`=6, `mcp`=5, `network`=10, `plugin`=6, `process-direct`=39, `process-indirect`=12, `runtime-boundary`=14, `skill`=15, `structured-file-read`=13, `structured-file-write`=14, `updater`=6, `upload`=7
...
| `ACE-SURF-PROC-DIRECT-DEV-E2E-BATCH` | `process-direct`, `dev-only` | `scripts/run_e2e_batch.py::batch E2E scenario runner spawning one subprocess per case` | Release Security maintainers | `dev-only` | run_e2e_batch.py fixed argv from scenarios.yaml, per-case subprocess isolation, and repository-local output roots |
...
| `ACE-SURF-PROC-DIRECT-HTML-PDF` | `process-direct`, `dev-only` | `crew/skills/html-to-pdf/scripts/convert.cjs::html-to-pdf skill converter delegating to a managed Chromium` | Skills maintainers | `dev-only` | convert.cjs fixed argv construction, byte/DOM/style budgets, per-stage timeouts, and Chromium process caps |
...
- Reviewed primitive references: `python-file:crew/browser/manager.py:Path.open`, `python-file:crew/browser/manager.py:os.open`, `python-file:crew/plugins/manager.py:Path.open`, `python-file:crew/plugins/manager.py:Path.write_text`, `python-file:crew/plugins/security.py:Path.open`, `python-file:crew/plugins/security.py:Path.read_bytes`, `python-file:crew/plugins/security.py:Path.read_text`, `python-file:crew/tools/cua_setup.py:Path.write_bytes`, `python-file:crew/tools/cua_setup.py:Path.write_text`, `python-file:crew/tools/file_utils.py:os.open`, `python-file:crew/tools/file_utils.py:os.replace`, `python-file:crew/tools/managed_tools.py:Path.open`, `python-file:crew/tools/pipeline.py:Path.write_text`, `python-file:crew/tools/process_registry.py:os.open`, `python-file:crew/wiki/archive_security.py:Path.open`, `python-file:crew/wiki/compiler.py:Path.read_text`, `python-file:crew/wiki/compiler.py:Path.write_text`, `python-file:crew/wiki/manager.py:Path.read_text`, `python-file:crew/wiki/manager.py:Path.write_text`, `python-file:crew/wiki/parser.py:Path.open`, `python-file:crew/wiki/prompts.py:Path.read_text`, `python-file:crew/wiki/seed.py:Path.open`, `python-file:crew/wiki/seed.py:Path.read_text`, `python-file:crew/wiki/seed.py:Path.write_text`, `python-file:crew/wiki/store/_filesystem.py:Path.open`, `python-file:crew/wiki/store/_filesystem.py:Path.read_bytes`, `python-file:crew/wiki/store/_filesystem.py:Path.read_text`, `python-file:crew/wiki/store/_filesystem.py:Path.write_text`
- Covered routes/channels: none
- Exception expiry: `none`
- Review deadline: `2027-12-31`
...
- Reviewed primitive references: `python-network:plugins/platforms/feishu/adapter.py:urllib.request.urlopen`, `python-network:plugins/platforms/weixin/adapter.py:aiohttp.ClientSession`, `python-network:plugins/platforms/weixin/ilink.py:aiohttp.ClientSession`
- Covered routes/channels: none
- Exception expiry: `none`
- Review deadline: `2027-12-31`
...
- Reviewed primitive references: `python-file:plugins/browser/compile_tool.py:Path.write_text`, `python-file:plugins/browser/compile_tool.py:os.open`, `python-file:plugins/browser/workflow_store.py:os.open`, `python-file:plugins/platforms/feishu/adapter.py:Path.read_text`, `python-file:plugins/platforms/feishu/adapter.py:Path.write_text`, `python-file:plugins/platforms/feishu/files.py:Path.write_bytes`, `python-file:plugins/platforms/weixin/adapter.py:Path.read_bytes`, `python-file:plugins/platforms/weixin/adapter.py:Path.read_text`, `python-file:plugins/platforms/weixin/adapter.py:Path.write_text`, `python-file:plugins/platforms/weixin/ilink.py:Path.read_text`, `python-file:plugins/platforms/weixin/ilink.py:Path.write_bytes`, `python-file:plugins/platforms/weixin/ilink.py:Path.write_text`
- Covered routes/channels: none
- Exception expiry: `none`
- Review deadline: `2027-12-31`
...
### ACE-SURF-PROC-DIRECT-DEV-E2E-BATCH

- Locator: `scripts/run_e2e_batch.py::batch E2E scenario runner spawning one subprocess per case`
- Trust source: Trusted checkout, repository scenario manifest, fixed case runner, and repository .venv interpreter
- Fail closed: Missing scenario manifest, unknown case, interpreter resolution failure, or child failure aborts the batch with a nonzero exit
- Lifecycle/revocation owner: Release CI job and E2E artifact owner
- Tests: `EXECUTION-SURFACE-INVENTORY` — `tests/security/test_execution_surface_inventory.py`
- Evidence: `pytest` — `tests/security/test_execution_surface_inventory.py`
- Artifact references: `pytest` — `tests/security/test_execution_surface_inventory.py`
- Reviewed primitive references: none
- Covered routes/channels: none
- Exception expiry: `none`
- Review deadline: `2027-12-31`
- Review trigger: Scenario manifest, case runner, interpreter resolution, subprocess argv, or output root changes
...
### ACE-SURF-PROC-DIRECT-HTML-PDF

- Locator: `crew/skills/html-to-pdf/scripts/convert.cjs::html-to-pdf skill converter delegating to a managed Chromium`
- Trust source: Trusted checkout skill script plus repository-managed Chromium candidates
- Fail closed: Oversized input or output, malformed options, budget breach, launch or render timeout, or leftover Chromium process fails the conversion
- Lifecycle/revocation owner: Skills maintainers and release CI
- Tests: `EXECUTION-SURFACE-INVENTORY` — `tests/security/test_execution_surface_inventory.py`
- Evidence: `pytest` — `tests/security/test_execution_surface_inventory.py`
- Artifact references: `pytest` — `tests/security/test_execution_surface_inventory.py`
- Reviewed primitive references: none
...
- Exception expiry: `none`
- Review deadline: `2027-12-31`
- Review trigger: Chromium candidate roots, argv construction, budget constants, or cleanup logic changes
...
- Reviewed primitive references: `python-file:crew/tools/process_registry.py:Path.read_text`
- Covered routes/channels: none
- Exception expiry: `none`
- Review deadline: `2027-12-31`
...
- Reviewed primitive references: `rust-file:security-runtime/src/macos/mod.rs:fs.write`
- Covered routes/channels: none
- Exception expiry: `none`
- Review deadline: `2027-12-31`
...
- Reviewed primitive references: `rust-file:security-runtime/src/windows/process.rs:fs.mutate`, `rust-file:security-runtime/src/windows/process.rs:fs.write`
- Covered routes/channels: none
- Exception expiry: `none`
- Review deadline: `2027-12-31`
...
- Reviewed primitive references: `javascript-file:desktop/src/main/update/github-release.ts:fs.readFileSync`
- Covered routes/channels: none
- Exception expiry: `none`
- Review deadline: `2027-12-31`
