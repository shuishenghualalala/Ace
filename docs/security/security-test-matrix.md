...
| SMX-ACP-001 | managed ACP bidirectional stdio | native runtime interactive session forwards stdin/stdout and closes child tree | same through Windows runner | same through macOS Seatbelt runtime | required |
