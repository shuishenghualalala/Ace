...
from helpers.xml_parser import lxml_fromstring, lxml_parse, xsd_parser
...
class BaseSchemaValidator:
    ...
    def repair_whitespace_preservation(self) -> int:
        ...
        for xml_file in self.xml_files:
            try:
                ...
                dom = defusedxml.minidom.parseString(content, forbid_dtd=True)
                modified = False
    ...
    def validate_namespaces(self):
        ...
        for xml_file in self.xml_files:
            try:
                root = lxml_parse(xml_file).getroot()
    ...
    def validate_file_references(self):
        ...
        for rels_file in rels_files:
            try:
                rels_root = lxml_parse(rels_file).getroot()
    ...
    def validate_all_relationship_ids(self):
        ...
        for xml_file in self.xml_files:
            ...
            try:
                ...
                xml_root = lxml_parse(xml_file).getroot()
    ...
    def validate_content_types(self):
        ...
        try:
            root = lxml_parse(content_types_file).getroot()
            declared_parts = set()
            ...
            for xml_file in self.xml_files:
                ...
                try:
                    root_tag = lxml_parse(xml_file).getroot().tag
    ...
    def _clean_ignorable_namespaces(self, xml_doc):
        ...
        xml_copy = lxml_fromstring(xml_string)
    ...
    def _validate_single_file_xsd(self, xml_file, base_path):
        ...
        try:
            xsd_doc = lxml.etree.parse(
                str(schema_path), parser=xsd_parser(), base_url=str(schema_path)
            )
            schema = lxml.etree.XMLSchema(xsd_doc)

            xml_doc = lxml_parse(xml_file)
